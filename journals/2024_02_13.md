  ...
  id:: 65cbfce2-bea2-46a2-a068-4d4dc4a06765
	...
	- ## What you need to implement in D2:
		...
		- A couple notes and warnings:
			- Only run dup2 in the child processes. If you overwrite stdin or stdout in the parent process, you will lose access to the TTY (terminal) for all subsequent processes
-