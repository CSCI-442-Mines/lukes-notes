  ...
  id:: 65cbfce2-bea2-46a2-a068-4d4dc4a06765
	...
	- ## What you need to implement in D2:
		...
		- **What is output by the open function, created by the pipe function, and represented in `STDIN_FILENO` and `STDOUT_FILENO`?**
			- File descriptors!
			- Every process image has a file descriptor table, which is accessed like any other array/table (via indices), and stores information about the open files.
			- Example fd table:
			  | Index | Description of file |
			  | 0 == STDIN_FILENO | stdin |
			  | 1 == STDOUT_FILENO | standard output (terminal write)
			-
			-
		- ```c
