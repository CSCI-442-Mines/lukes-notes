	...
	- ## What you need to implement in D2:
		...
		- **How does pipe work?**
			- Lets refer to the manpage for pipe.
			  ...
			  ```
			  So pipe creates a unidirectional data flow (unidirectional meaning that data can only from from one input end to an output end, similar to real life pipes that carry)