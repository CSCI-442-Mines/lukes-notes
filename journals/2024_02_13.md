...
- # Project 2 Deliverable 2 Recitation
  id:: 65cbfce2-bea2-46a2-a068-4d4dc4a06765
	...
	- ## What you need to implement in D2:
		...
		- ```c
		  // It may be useful to have a variable track the write end of the previous pipe.
		  int prev_pipe_read_end;
		  // pipefd[0] - read end of the pipe (in place of stdin)
		  // pipefd[1] - write end of the pipe (in place of stdout)
		  int[2] pipefd; // [3, 4]
